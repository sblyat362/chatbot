...
# Flask app (no run() needed for Vercel)
app = Flask(__name__)

# Embed your base64 encoded credentials (replace this string)
...
# Decode credentials and write to a temp file
